...
{
{
    ...
    name = "adikings-big-laser-turret",
    icon = "__OneMaksik__/graphics/icons/big-laser-turret.png",
    icon_size = 32,
    flags = { "placeable-player", "placeable-enemy", "player-creation"},
    minable = { mining_time = 5, result = "adikings-big-laser-turret" },
    max_health = 10000,
    ...
    {
      type = "electric",
      buffer_capacity = "12800kJ",
      input_flow_limit = "38400kW",
      drain = "3500kW",
